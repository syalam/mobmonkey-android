 ...
 *
 */
public class MMHistoryArrayAdapter extends ArrayAdapter<MMSearchResultsItem> {
	private LayoutInflater layoutInflater;
	private int listRowLayout;
	private MMSearchResultsItem[] locations;
	
	public MMHistoryArrayAdapter(Context context, int listRowLayout, MMSearchResultsItem[] locations) {
