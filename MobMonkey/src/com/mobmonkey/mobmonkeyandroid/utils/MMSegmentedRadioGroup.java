...
/**
 * @author Make Ramen, LLC
 * @author Dezapp, LLC
 *
 */
public class MMSegmentedRadioGroup extends RadioGroup {

	public MMSegmentedRadioGroup(Context context) {
		super(context);
	}

	public MMSegmentedRadioGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
