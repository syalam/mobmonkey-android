 ...
 *
 */
public class MMHistoryArrayAdapter extends ArrayAdapter<MMResultsLocation> {
	private LayoutInflater layoutInflater;
	private int listRowLayout;
	private MMResultsLocation[] locations;
	
	public MMHistoryArrayAdapter(Context context, int listRowLayout, MMResultsLocation[] locations) {
